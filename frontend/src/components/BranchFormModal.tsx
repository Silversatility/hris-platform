...
const EMPTY_VALUES: FormValues = { name: '', code: '', address: '', is_active: true }
...
function BranchFormModal({ isOpen, branch, onClose, onSaved }: BranchFormModalProps) {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      if (isEdit) {
        await apiClient.patch(`/api/branches/${branch.id}/`, values)
      } else {
